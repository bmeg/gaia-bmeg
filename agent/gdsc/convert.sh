...
./gdsc-convert.py GDSC-CCLE-CTRP_conversion.xlsx Cell_Lines_Details.xlsx Screened_Compounds.xlsx v17a_public_raw_data.xlsx v17_fitted_dose_response.xlsx
